...
<html>
	...
	<body>
		...
		<div id="edit-propiedad" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${propiedadInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${propiedadInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:propiedadInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${propiedadInstance?.version}" />
				<fieldset class="form">
